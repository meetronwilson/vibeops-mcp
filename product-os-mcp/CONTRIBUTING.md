# Contributing to Product OS MCP Server

Thank you for your interest in contributing to Product OS MCP Server!
...
1. Check if the bug has already been reported in [Issues](https://github.com/vibeops/product-os/issues)
...
1. Check if the feature has been suggested in [Issues](https://github.com/vibeops/product-os/issues)
2. Create a new issue with:
   - Clear use case
...
```json
{
  "mcpServers": {
    "product-os": {
      "command": "node",
      "args": ["/path/to/your/product-os-mcp/build/index.js"],
